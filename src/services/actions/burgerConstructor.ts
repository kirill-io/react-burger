...
export interface IReplacementIngredient {
  readonly type: typeof REPLACEMENT_INGREDIENT;
  ingredient: IIngredientData;
  key: string;
}
...
export type TBurgerConstructorActions =
  | IAddingIngredient
  | IReplacementIngredient
  | IMoveIngredient
  | IDeleteIngredient
  | ICleanIngredient;

export const addingIngredient =
  (typeIngredient: string, ingredient: IIngredientData | undefined) =>
...
export const deleteIngredient =
  (elementKey: string) => (dispatch: AppDispatch) => {
    dispatch({
